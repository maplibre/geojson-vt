...
- Remove default export in favor of named exports - breaking change - use `new GeoJSONVT(...)` instead of `geojsonvt(...)` ([#58](https://github.com/maplibre/geojson-vt/pull/58)) (by [HarelM](https://github.com/HarelM)) 
